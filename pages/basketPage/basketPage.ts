...
export default class BasketPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.additionalServicePrices = page.locator(
      '.PriceBlock_priceBlock__bLP4B.ServiceBlock_price__mpCOu'
    );
    ...
    this.addServiceBtn = this.allServicesSheet.locator('[aria-label="Добавить услугу"]');
    this.closeAllServicesSheetBtn = page.locator('[data-testid="icon"]');
