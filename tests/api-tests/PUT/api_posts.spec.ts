...
test.describe('Check the PUT method can be used to update posts', () => {
  test('Check the post is updated and the request returns the status code 200', async ({
    request,
  }) => {
  ...
  test('Check the request returns the status code 404 for non-existing post', async ({
    request,
  }) => {
